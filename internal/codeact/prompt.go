...
func generateXmlToJson(plan schema.Plan) (string, error) {
	...
	b.WriteString("\t\t\tif err != nil { return nil, err }\n")
	b.WriteString("\t\t\tif child != nil {\n")
	b.WriteString("\t\t\t\tif len(node) == 0 {\n")
	b.WriteString("\t\t\t\t\tval = child\n")
	b.WriteString("\t\t\t\t} else {\n")
	b.WriteString("\t\t\t\t\tnode[\"value\"] = child\n")
	...
	b.WriteString("\t\t\t\t// Simplified handling\n")
	b.WriteString("\t\t\t}\n")
	b.WriteString("\t\t}\n")
	b.WriteString("\t}\n")
	b.WriteString("\treturn result, nil\n")
	...
	b.WriteString("\t\t\tif err != nil { return err }\n")
	b.WriteString("\t\t\troot = map[string]any{start.Name.Local: val}\n")
	b.WriteString("\t\t\tbreak\n")
	b.WriteString("\t\t}\n")
	b.WriteString("\t}\n\n")
