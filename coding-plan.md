...
fecha: 2026-06-03
etapa: ETAPA_2
subtarea: ampliar detecci�n de intenci�n
estado: completado
resultado: el planificador ahora reconoce variantes espa�olas adicionales de conversi�n como "convierte" y "transforma"; `go test ./internal/schema` qued� en verde
siguiente: decidir si la pr�xima mejora peque�a debe ir en planificador, parser o trazabilidad
bloqueos: ninguno
[/IA-STEP]
```
