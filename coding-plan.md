...
fecha: 2026-06-03
etapa: ETAPA_1
subtarea: cubrir listas de objetos en YAML
estado: completado
resultado: `InspectYAML` ahora extrae columnas desde el primer mapa de una lista y `go test ./internal/parsers` qued� en verde
siguiente: seguir reforzando parsers o avanzar a otra pieza peque�a del flujo
bloqueos: ninguno
[/IA-STEP]
```
