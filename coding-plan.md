...
fecha: 2026-06-03
etapa: ETAPA_5
subtarea: cubrir invalidaci�n del retry loop
estado: completado
resultado: se agreg� prueba para `RetryRunPlan` con `maxAttempts` inv�lido; `go test ./internal/codeact` qued� en verde
siguiente: seguir reforzando el loop o avanzar a otra pieza peque�a si conviene
bloqueos: ninguno
[/IA-STEP]
```
