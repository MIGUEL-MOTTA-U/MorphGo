...
fecha: 2026-06-03
etapa: ETAPA_2
subtarea: asegurar serializaci�n de rutas en plan
estado: completado
resultado: `Plan` ahora verifica serializaci�n de `input_path` y `output_path`; `go test ./internal/schema` qued� en verde
siguiente: seguir reforzando planificador o avanzar a otra pieza peque�a del flujo
bloqueos: ninguno
[/IA-STEP]
```
