...
estado: completado
resultado: se agreg� cobertura para el caso en que `SaveRun` recibe una ruta base inv�lida y falla limpiamente; `go test ./internal/telemetry` qued� en verde
siguiente: revisar otra pieza peque�a de trazabilidad o persistencia si hace falta
bloqueos: ninguno
[/IA-STEP]
```
